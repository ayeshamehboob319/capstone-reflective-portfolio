...
### 🔹 Tic Tac Toe Game
- Developed a simple coding-based Tic Tac Toe game  
- Strengthened programming logic and problem-solving skills  

---

### 🔹 Stack-Based Text Editor
- Built a text editor using stack data structure  
...
- Designed a solar tracking system using LDRs  
- Automatically adjusts panel position toward sunlight  
- Learned practical hardware and digital logic concepts  

---

### 🔹 Virtual Machine & Network Configuration (VirtualBox)
- Created and managed virtual machines using ISO files  
- Installed operating systems in virtual environments  
- Configured FTP for file transfer  
- Worked on DNS setup  
- Created and managed users  
- Applied user restrictions and permissions  
- Gained hands-on experience in networking and system administration  
