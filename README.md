...
### 🔹 Tic Tac Toe Game
A simple interactive game developed using programming fundamentals.

- Strengthened logical thinking and decision-making  
- Practiced condition handling and game flow design  

---

### 🔹 Stack-Based Text Editor
A text editor implemented using stack data structure.

- Implemented undo/redo functionality using stacks  
- Improved understanding of data structures and memory operations  

---

### 🔹 Solar Tracker System (DLD Project)
A hardware-based project designed using Digital Logic Design concepts.

- Used LDR sensors for sunlight detection  
- Automatically adjusts solar panel direction  
- Gained hands-on experience in hardware logic and circuits  

---

### 🔹 Virtual Machine & Network Configuration (VirtualBox)
A system administration and networking-based project.

- Created and managed virtual machines using ISO installations  
- Configured FTP server, DNS setup, and user management  
